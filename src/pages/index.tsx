  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Srvy, your ultimate platform for creating, distributing, and analyzing surveys with ease. Transform your research with our innovative tools and dynamic features."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Srvy, your ultimate platform for creating, distributing, and analyzing surveys with ease. Transform your research with our innovative tools and dynamic features.`}
            </Text>
            <Box
